...
public final class Constants {
  ...
  public static final class Arm{
    public static final class Elevator{
      ...
      public static final double kP = 0.0007473;
      public static final double kI = 0.0;
      public static final double kD = 0.0;

      public static final double ampLimit = 60;
      public static final double maxVelo = 2000;
      public static final double minVelo = -2000;
      public static final double maxAcc = 300;
    ...
    public static final class Shoulder {
      ...
      public static final double targetPosition1 = 0.1;
      public static final double targetPosition2 = 0.221;
      public static final double targetPosition3 = 0.221;
      public static final double targetPosition4 = 0.680;
      public static final double targetPosition5 = 0.664;
      public static final double targetPosition6 = 0.724;
      public static final double targetPosition7 = 0.677;
      public static final double targetPosition8 = 0.174;
    }
    ...
    public static final class Claw {
      ...
      public static final double ampLimit = 80;
    }
  }
  ...
  public static final class Swerve {
    ...
    public static final class Mod0 {
        ...
        public static double angleOffset = 47.72;//314.5 these aren't accurate just refences
    ...
    public static final class Mod1 {
        ...
        public static double angleOffset = 78.75;//246.7
        public static final SwerveModuleConstants constants =
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
    }
    ...
    public static final class Mod2 {
        ...
        public static double angleOffset = 275.98;//.47
        public static final SwerveModuleConstants constants =
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
    }
    ...
    public static final class Mod3 {
        ...
        public static double angleOffset = 178.07;//257.95
        public static final SwerveModuleConstants constants =
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
    }
