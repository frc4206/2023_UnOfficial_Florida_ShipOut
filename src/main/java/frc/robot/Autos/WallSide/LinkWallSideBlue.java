...
package frc.robot.Autos.WallSide;
...
public class LinkWallSideBlue extends SequentialCommandGroup {
  PathPlannerTrajectory path = PathPlanner.loadPath("Link Wall Side Blue", new PathConstraints(2.5, 1.25));
  
  public LinkWallSideBlue(SwerveSubsystem swerve) {
