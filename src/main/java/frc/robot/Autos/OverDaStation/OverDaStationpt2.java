...
public class OverDaStationpt2 extends SequentialCommandGroup {
  PathPlannerTrajectory path = PathPlanner.loadPath("please", new PathConstraints(1.5, 1.5));
  
  public OverDaStationpt2(SwerveSubsystem swerve) {
